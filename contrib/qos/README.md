...
This means one can have an always-on globycoind instance running, and another local globycoind/globycoin-qt instance which connects to this node and receives blocks from it.
