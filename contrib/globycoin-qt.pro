...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/globycoin-cli.cpp \
           src/globycoin-tx.cpp \
           src/globycoin.cpp \
           src/db.cpp \
           ...
           src/qt/globycoin.cpp \
           src/qt/globycoinstrings.cpp \
...
RESOURCES += src/qt/globycoin.qrc src/qt/globycoin_locale.qrc

TRANSLATIONS += src/qt/locale/globycoin_bg.ts \
                src/qt/locale/globycoin_de.ts \
                src/qt/locale/globycoin_en.ts \
                src/qt/locale/globycoin_es.ts \
                src/qt/locale/globycoin_fi.ts \
                src/qt/locale/globycoin_fr.ts \
                src/qt/locale/globycoin_it.ts \
                src/qt/locale/globycoin_ja.ts \
                src/qt/locale/globycoin_pl.ts \
                src/qt/locale/globycoin_pt.ts \
                src/qt/locale/globycoin_ru.ts \
                src/qt/locale/globycoin_sk.ts \
                src/qt/locale/globycoin_sv.ts \
                src/qt/locale/globycoin_vi.ts \
                src/qt/locale/globycoin_zh_CN.ts \
                src/qt/locale/globycoin_zh_TW.ts
