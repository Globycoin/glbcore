Contributing to Globycoin Core
============================

The Globycoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Globycoin Core project, and is not to be
confused with overall Globycoin Network Protocol consensus changes.

Whether a pull request is merged into Globycoin Core rests with the project merge
...
Patches that change Globycoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Globycoin consensus, it must have been
...
The project leader is the release manager for each Globycoin Core release.
