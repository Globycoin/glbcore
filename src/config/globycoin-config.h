/* src/config/globycoin-config.h.  Generated from globycoin-config.h.in by configure.  */
/* src/config/globycoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef GLBUR_CONFIG_H

#define GLBUR_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.globycoin.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Globycoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Globycoin Core 1.1.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "globycoin"
