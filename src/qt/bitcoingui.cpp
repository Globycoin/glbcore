...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Globycoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and globycoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zGLB"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Globycoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Globycoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Globycoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Globycoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Globycoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Globycoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Globycoin Core help message to get a list with possible Globycoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Globycoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Globycoin network", "", count));
}
...
{
    QString strTitle = tr("Globycoin Core"); // default title
