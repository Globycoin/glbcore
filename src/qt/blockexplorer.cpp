...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::GLB, nValue);
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", false)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (globycoin.conf).");
            QMessageBox::warning(this, "Globycoin Core Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
...
void BlockExplorer::setContent(const std::string& Content)
{
    ...
    QString CSS = "body {font-size:12px; color:#f8f6f6; bgcolor:#E29194;}\n a, span { font-family: monospace; }\n span.addr {color:#E29194; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #E29194;}\n td.d0 {font-weight: bold; color:#f8f6f6;}\n h2, h3 { white-space:nowrap; color:#E29194;}\n a { color:#FFFC00; text-decoration:none; }\n a.nav {color:#E29194;}\n";
