                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Globycoin from zGlobycoin"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zGlobycoin"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zGlobycoin));
