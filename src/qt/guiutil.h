...
/** Utility functions used by the Globycoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Globycoin addresses in monospace font
...
// Parse "globycoin:" URI into recipient object, return true on successful parsing
