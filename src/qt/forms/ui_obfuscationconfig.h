...
public:
    ...
    void retranslateUi(QDialog *ObfuscationConfig)
    {
        ...
        label_2->setText(QApplication::translate("ObfuscationConfig", "Use 2 separate masternodes to mix funds up to 10000 GLB", 0));
        label_3->setText(QApplication::translate("ObfuscationConfig", "Use 8 separate masternodes to mix funds up to 10000 GLB", 0));
        label_4->setText(QApplication::translate("ObfuscationConfig", "Use 16 separate masternodes", 0));
        label_6->setText(QApplication::translate("ObfuscationConfig", "This option is the quickest and will cost about ~0.025 GLB to anonymize 10000 GLB", 0));
        label_7->setText(QApplication::translate("ObfuscationConfig", "This option is moderately fast and will cost about 0.05 GLB to anonymize 10000 GLB", 0));
        ...
        label_9->setText(QApplication::translate("ObfuscationConfig", "0.1 GLB per 10000 GLB you anonymize.", 0));
    } // retranslateUi
