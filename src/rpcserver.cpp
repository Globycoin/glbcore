...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Globycoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Globycoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Globycoin features */
        {"globycoin", "masternode", &masternode, true, true, false},
        {"globycoin", "listmasternodes", &listmasternodes, true, true, false},
        {"globycoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"globycoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"globycoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"globycoin", "masternodedebug", &masternodedebug, true, true, false},
        {"globycoin", "startmasternode", &startmasternode, true, true, false},
        {"globycoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"globycoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"globycoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"globycoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"globycoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"globycoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"globycoin", "mnbudget", &mnbudget, true, true, false},
        {"globycoin", "preparebudget", &preparebudget, true, true, false},
        {"globycoin", "submitbudget", &submitbudget, true, true, false},
        {"globycoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"globycoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"globycoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"globycoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"globycoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"globycoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"globycoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"globycoin", "checkbudgets", &checkbudgets, true, true, false},
        {"globycoin", "mnsync", &mnsync, true, true, false},
        {"globycoin", "spork", &spork, true, true, false},
        {"globycoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"globycoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use globycoind, or the -server option to globycoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> globycoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6070/\n";
}
