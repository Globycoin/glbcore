...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Globycoin Core globycoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  globycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded globycoin transaction") + "\n" +
                               "  globycoin-tx [options] -create [commands]   " + _("Create hex-encoded globycoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded globycoin transaction
