...
// Globycoin: on startup load spork values from previous session if they exist in the sporkDB
...
void ProcessSpork(CNode* pfrom, std::string& strCommand, CDataStream& vRecv)
{
    ...
    if (strCommand == "spork") {
        ...
        // Globycoin: add to spork database.
...
bool CSporkManager::CheckSignature(CSporkMessage& spork)
{
    ...
    string strSporkKey = "04afc8d45a997170ba085f9e03803b21f040157c90e0388f44c100959c4017142a31d1b5e4a271881bdcf86929768318af3cb4ecb1dae9c7774634154a229ab0b0";
