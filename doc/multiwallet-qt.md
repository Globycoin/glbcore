...
In order to support loading of multiple wallets in globycoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is globycoin.cpp.
...
Changes to globycoin.cpp
----------------------
globycoin.cpp is the entry point into globycoin-qt, and as such, will require some minor modifications to provide hooks for
